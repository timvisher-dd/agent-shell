...
(declare-function agent-shell--update-usage-from-notification "agent-shell")
(declare-function agent-shell--debug-log-notification-error "agent-shell")
(declare-function agent-shell--make-tool-call-permission-text "agent-shell")
...
(declare-function agent-shell--on-fs-read-text-file-request "agent-shell")
(declare-function agent-shell--on-fs-write-text-file-request "agent-shell")
